...
class Db(object):
    ...
    def __init__(self):
        ...
        self.conn = MySQLdb.connect(host=self.host,port=3307,user=self.user, passwd=self.password, db=self.db,
    ...
    def clicked(self, domain, clicked):
        ...
        query = f'UPDATE ORM.domain SET ORM.domain.clicked = {clicked} WHERE ORM.domain.name = "{domain_name}"'
